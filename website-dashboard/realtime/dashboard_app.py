...
<body>
  ...
  <script>
    ...
    async function loadVideoSource() {
      ...
      videoModeEl.value = mode === 'clips' ? 'clips' : 'youtube';
    ...
    async function saveVideoSource() {
      const mode = videoModeEl.value === 'clips' ? 'clips' : 'youtube';
...
class TrackingEngine:
    ...
    def _create_video_input(self, video_cfg: Dict[str, Any]) -> VideoInputModule:
      ...
      return VideoInputModule(
        source=source,
        fallback_source=video_cfg.get("fallback_source"),
        ...
        youtube_cookiefile=str(video_cfg.get("youtube_cookiefile", "")),
