...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "tracking": {
        ...
        "hybrid_target_fps": 30.0,
        "api_refresh_every_n_frames": 30,
        "local_preload_enabled": True,
        "local_fill_enabled": True,
        "local_fill_max_fps": 4.0,
        "local_refresh_every_n_frames": 8,
        "cache_fallback_max_age_frames": 30,
